...
$(document).ready(function() {
    ...
    function init() {
        ...
        (window.unsafeWindow || window).initPlayers = (data) => {
            ...
            //console.log(data); //my change
            unsafeWindow.applyDeckSpecificSleeves(data.player1, data.player2); //my change
        ...
        (window.unsafeWindow || window).CardFront = function CardFront() {
            ...
            card.loadImage = () => {
                ...
                unsafeWindow.applyCustomFrame(card, card.data('name'), card.data('passcode'), color, isPendulum); //my change
                unsafeWindow.removeCustom(card); //my change
            };
            return card;
        };
